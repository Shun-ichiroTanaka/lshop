    ...
    <body>
        <header class="with-background">
            <div class="top-nav container">
                <div class="logo">Surfboard Shop</div>
                <ul>
            ...
            <div class="hero container">
                ...
                <div class="hero-image">
                    <img src="img/11.svg" alt="hero image">
                </div> <!-- end hero-image -->
            </div> <!-- end hero -->
        </header>
            ...
            <div class="container">
                ...
                <div class="blog-posts">
                    <div class="blog-post" id="blog1">
                        <a href="#"><img src="/img/blog1.jpeg" alt="Blog Image"></a>
                    ...
                    <div class="blog-post" id="blog2">
                        <a href="#"><img src="/img/blog2.jpeg" alt="Blog Image"></a>
                        <a href="#"><h2 class="blog-title">Blog Post Title 2</h2></a>
                        <div class="blog-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi, tenetur numquam ipsam reiciendis.</div>
                    </div>
                    <div class="blog-post" id="blog3">
                        <a href="#"><img src="/img/blog3.jpeg" alt="Blog Image"></a>
